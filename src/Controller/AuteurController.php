...
final class AuteurController extends AbstractController
{
    ...
    #[Route('/nouveau', name: 'app_admin_auteur_new', methods: ['GET', 'POST'])]
    ...
    public function modifier(Request $request, Auteur $auteur, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(AuteurType::class, $auteur);
        $form->handleRequest($request);
    ...
    public function supprimer(Request $request, Auteur $auteur, EntityManagerInterface $entityManager): Response
    {
