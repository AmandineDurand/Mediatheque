...
final class CategorieController extends AbstractController
{
    ...
    #[Route('/nouveau', name: 'app_admin_categorie_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}/modifier', name: 'app_admin_categorie_edit', methods: ['GET', 'POST'])]
    ...
    public function supprimer(Request $request, Categorie $categorie, EntityManagerInterface $entityManager): Response
    {
